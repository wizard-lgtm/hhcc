...
class Compiler:
    ...
    def __init__(self, file, debug=False, dump_ast=False, dump_tokens=False, dump_defines=False, 
                 dump_preprocessed=False, dump_llvmir=False, dump_symboltable=False, triple=None, 
                 target=None, output_file=None, emit_llvm=False, compile_only=False, link_libs=None, 
                 lib_paths=None, object_files=None):
        self.version = "0.1.1"  
        ...
        self.dump_symboltable = dump_symboltable  # NEW
    ...
    def compile(self):
        ...
        # NEW: Dump symbol table if requested
        if self.dump_symboltable:
            print("==== Symbol Table ====")
            codegen.symbol_table.print_tree()
            print("======================")
...
def parse_args():
    ...
    parser.add_argument("-ds", "--dump-symboltable", action="store_true", help="Dump symbol table")  # NEW
...
if __name__ == "__main__":
    ...
    compiler = Compiler(
        ...
        dump_symboltable=args.dump_symboltable,  # NEW
        triple=args.triple, 
        target=target, 
